...
public class Unicode2Word {

	final private static int HANZI_START = 19968;
	final private static int HANZI_COUNT = 20902;
	private static String firstLetterArray = "ydkqsxnwzssxjbymgcczqpssqbycdscdqldylybssjgyqzjjfgcclzznwdwzjljpfyynnjjtmynzwzhflzppqhgccyynmjqyxxgd"
	...
	public String pinyinFirstLetter(String hanzi) {
		...
		int index = c[0] - HANZI_START;
		if (index >= 0 && index <= HANZI_COUNT) {
			return firstLetterArray.substring(index, index + 1).toUpperCase();
		} else {
			return "#";
		}
	}
