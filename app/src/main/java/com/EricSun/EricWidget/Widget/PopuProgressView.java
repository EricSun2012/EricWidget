 ...
 */
//public class PopuProgressView extends View {
//    private RectF oval = new RectF(14,16,14,16);
//    private Paint backgroundPaint;
//
//    public PopuProgressView(Context context) {
//        this(context, null);
//    }
//
//    public PopuProgressView(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
//    }
//
//    public PopuProgressView(Context context, AttributeSet attrs, int defStyle) {
...
//        super.draw(canvas);
//        canvas.save();
//        canvas.drawRoundRect(oval,10,10,backgroundPaint);
//        canvas.restore();
//    }
//
//    @Override
 ...
 *
 */
public class PopuProgressView extends View implements OnTouchListener,OnClickListener {
    ...
    public interface DragListener{
        public void onDrag(PopuProgressView view, float value);
    }
            ...
            if (isAverageScale) {// 均分的刻度
                ...
                if (isDrawScaleUp) {
                    for (int i = 0; i < mScaleList.size(); i++) {
                        double number = (Double)mScaleList.get(i);
